package com.example.mlcircularprimes.components;
...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
	...
	public ExpandableListAdapter(Context context, List<Object[]> listDataHeader, HashMap<String, List<String>> listChildData) {
	...
	public Object getChild(int groupPosition, int childPosititon) {
		return this._listDataChild.get(this._listDataHeader.get(groupPosition)[0]).get(childPosititon);
	}
